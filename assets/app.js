...
function bootstrapCommonMakesIfEmpty() {
  ...
  const common = [
    "Chevrolet","GMC","Mazda","Ram","Toyota","Honda","Nissan","Hyundai","Kia",
...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Mazda Braintree"],
    ["successTitle", "¡Gracias! - Quirk Mazda Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Mazda Braintree se pondrá en contacto con usted en breve."]
  ]);
